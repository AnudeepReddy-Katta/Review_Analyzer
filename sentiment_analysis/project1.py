...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    # Your code here
    x = (np.dot(feature_vector, theta) + theta_0) * label
    if x > 1:
        return 0
    else:
        return 1 - x
...
def perceptron_single_step_update(
    ...
    """
    # Your code here
    x = (np.dot(feature_vector, current_theta) + current_theta_0) * label
    if x <= 0:
...
def average_perceptron(feature_matrix, labels, T):
    ...
    """
    # Your code here
    current_theta = theta = np.zeros(feature_matrix.shape[1])
    ...
    for t in range(T):
        for i in get_order(feature_matrix.shape[0]):
            ...
            current_theta, current_theta_0 = perceptron_single_step_update(feature_matrix[i], labels[i], current_theta,
                                                                           current_theta_0)
            theta = np.add(current_theta,theta)
            theta_0 += current_theta_0
    return (theta / (T * feature_matrix.shape[0]), theta_0 / (T * feature_matrix.shape[0]))
#pragma: coderesponse end
    ...
    for t in range(T):
        for i in get_order(feature_matrix.shape[0]):
            ...
            current_theta, current_theta_0 = pegasos_single_step_update(feature_matrix[i], labels[i], L,
                                                                        1 / np.sqrt(counter), current_theta,
                                                                        current_theta_0)
    return (current_theta, current_theta_0)
#pragma: coderesponse end
...
def classify(feature_matrix, theta, theta_0):
    ...
    """
    # Your code here
    return np.array([1 if e>0 else -1 for e in np.dot(feature_matrix,theta)+theta_0])
#pragma: coderesponse end
